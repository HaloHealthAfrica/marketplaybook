<template>
    <div class="content-wrapper py-8">
        ...
        >
            <div>
                <h1 class="heading-page mb-2">Stock Watchlists</h1>
        ...
        <!-- Watchlists Grid -->
        <div
            v-else-if="isProUser && watchlists.length > 0"
        ...
        <!-- Empty State -->
        <div
            v-else-if="!authLoading && isProUser && !loading"
